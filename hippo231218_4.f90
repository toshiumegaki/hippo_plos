...
double precision Xinit(ndim) ; data Xinit/0.05D0, 0.2D0, 0.D0/ !initial concentration
...
!
    OPEN(UNIT=10, file='surat_t231218_4.dat',status='replace')
    OPEN(UNIT=20, file='Xyzw_t231218_4.dat',status='replace')
!    
